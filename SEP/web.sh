...
log "Netwerkconfiguratie voltooid.  STATTIC IP: $STATIC_IP_WEB, NETMASK: $NETMASK_VLAN11, GATEWAY: $GATEWAY_VLAN11, INTERFACE: $INTERFACE. DNS-server instellen op $DNS_SERVER."
